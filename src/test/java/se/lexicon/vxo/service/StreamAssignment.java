...
public class StreamAssignment {
    ...
    public void task1(){
        ...
        //Write code here
        Stream<Integer> fromIntegers = integers.stream();
        fromIntegers.forEach(System.out::println);
    ...
    public void task10(){
        ...
        optional = people.stream().filter(person -> person.getPersonId() == personId)
                .findFirst().map(person -> person.getDateOfBirth().getDayOfWeek() + " " +
    ...
    public void task12(){
        ...
        result = people.stream().filter(person -> person.getFirstName()
                .equalsIgnoreCase(String.valueOf(new StringBuilder(person.getFirstName()).reverse())))
                .map(Person::getFirstName).distinct().sorted()
                .toArray(String[]::new);
    ...
    public void task13(){ //todo maybe can make the code even clearer
        ...
        List<Person> values = people.stream().filter(person -> person.getLastName().equalsIgnoreCase(k))
                .collect(Collectors.toList());
    ...
    public void task14(){
        ...
        _2020_dates = Stream.iterate(LocalDate.parse("2020-01-01"), date -> date.plusDays(1))
                .limit(DAYS.between(LocalDate.ofYearDay(2020,1), LocalDate.ofYearDay(2021,1)))
